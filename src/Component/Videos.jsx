...
function Videos(props) {
        ...
        const [vidsrc,setvideos]=useState(videosArr[0])


    return (
       <Stack h={"100vh"} direction={['column','row']} margin={"40px"}>
        <VStack w={"full"}>
        <video
            autoPlay        
            controls
            ...
            <VStack alignItems={"flex-start"} p={'8'} w={'full'} overflowY={'auto'}>
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae unde quos nam.</p>
            </VStack>
